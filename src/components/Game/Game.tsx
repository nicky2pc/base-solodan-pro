...
const Game = () => {
  ...
  const preloadImages = async () => {
    ...
    const imageCachePlayer = {
      "main": [
        "/chars/15.svg",      // Basic
        "/chars/premium.svg"  // Premium (создай/загрузи новый спрайт)
      ]
    };
  ...
  const resetGameObjects = () => {
    playerTank.current = createPlayerTank(selectedCharacter);
  ...
  const handleCharacterSelect = (charType: 'basic' | 'premium') => {
    ...
    >
      <div style={{
            ...
            <div className="bg">
              ...
              <div className="game-menu" style={{
                ...
                {!isConnected && (
                  ...
                  <button className={"play-btn"} onClick={handleStartGame} style={{minWidth: "240px"}} disabled={isStartButtonDisabled}>
                    {isConnected ? "Choose Character" : "Play as a guest"}
                  </button>
                </div>
                <div style={{
                  display: "flex",
        ...
        {gameState === 'gameover' && (
          ...
          {isConnected && gameStat.totalScore < 1 && (
            <span style={{
              display: 'block',
              fontSize: '20px',
              marginTop: '12px',
          ...
          />
              ...
              <div className="game-menu" style={{ display: 'flex', 
                ...
                {!isConnected && (
                   ...
                   <button className={"play-btn"} onClick={handleStartGame} style={{width: isConnected ? '310px' : 'auto'}}>
                    {isConnected ? "Choose Character" : "Play as a guest"}
                  </button>
                  </div>
